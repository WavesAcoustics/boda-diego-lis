...
from (
  values
    ...
    ('home', 'Maletas buenas para viajar', 'Para la luna de miel y para todos los viajes que vengan después. De esos regalos que no parecen románticos hasta que los necesitas.', 7500, 0, 'https://unsplash.com/photos/NhFBRL_BFxI/download?force=true&w=1200', true, true, 23),
    ...
    ('home', 'Purificador de aire', 'Para tener una casa más cómoda, limpia y agradable. Un regalo útil, discreto y de esos que se agradecen todos los días.', 4500, 0, 'https://unsplash.com/photos/M4OilrUTWyc/download?force=true&w=1200', true, true, 29),
